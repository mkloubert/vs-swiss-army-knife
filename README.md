...
| REST API | Provides an optional REST API to control your editor. | [![Latest Release](https://vsmarketplacebadge.apphb.com/version-short/mkloubert.vs-rest-api.svg)](https://marketplace.visualstudio.com/items?itemName=mkloubert.vs-rest-api) |
| REST Client | REST Client for Visual Studio Code. | [![Latest Release](https://vsmarketplacebadge.apphb.com/version-short/humao.rest-client.svg)](https://marketplace.visualstudio.com/items?itemName=humao.rest-client) |
